...
function toggleHearts() {
  const regularHeart = document.querySelector('.fa-regular.fa-heart');
  const solidHeart = document.querySelector('.fa-solid.fa-heart');

  // Kiểm tra trạng thái hiển thị của icon thứ nhất (fa-regular)
  const isRegularVisible = window.getComputedStyle(regularHeart).display !== 'none';
